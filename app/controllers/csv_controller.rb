class CsvController < ApplicationController
  ...
  def upload
    ...
    lead_source     = params[:upload][:lead_source]
    response_type   = params[:upload][:response_type]
    ...
    table.save
    # lead_source and response_type will be appended to each record when saved to the proper model.
